...
let [userd,objecd,arayobjectd] =await Promise.all([userdetails,object,arrayobject]);
console.log(userd,objecd,arayobjectd);


//we can get the results with one variable as well, it will get the array of results . 
let results =await Promise.all([userdetails,object,arrayobject]);
console.log(results);